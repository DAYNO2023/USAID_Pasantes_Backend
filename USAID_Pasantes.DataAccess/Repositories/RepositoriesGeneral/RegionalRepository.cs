...
namespace USAID_Pasantes.DataAccess.Repositories.RepositoriesGeneral
{
    ...
    {
        /// <summary>
        /// Obtiene una lista de las regionales por la universidad.
        /// </summary>
        /// <returns>Lista de regionales disponibles.</returns>
        public virtual IEnumerable<tbRegionales> ListByUniversity(int? id)
        {
            ...
            using (var db = new SqlConnection(USAID_Pasantes.ConnectionString))
            {
                ...
                result = db.Query<tbRegionales>(ScriptsDataBase.ListarRegionalesPorUniversidad, parameter, commandType: CommandType.StoredProcedure).ToList();
                return result;
            }
        }
